...
if __name__ == "__main__":
    ...
    #relacao de dispositivos e ssis
    dispXssid = directProbes.select("Source","ssid").distinct()

    #dispositivos X pnl
    ssidsXdevices = dispXssid.groupBy('ssid').count()
    ssidsXdevices2 = ssidsXdevices.selectExpr("ssid as SSID", "Count as qtdDevices")
    
    query = ssidsXdevices2\
        .writeStream\
        .outputMode('complete')\
        .foreach(processRow)\
        .start()
